...
import bgu.spl181.net.impl.UserServiceTextBasedProtocol.ConnectionsForBidi;
...
public class Reactor<T> implements Server<T> {
    ...
    private ConnectionsForBidi connections;
    ...
    public Reactor(
        ...
        this.connections= new ConnectionsForBidi();
    }
    ...
    private void handleAccept(ServerSocketChannel serverChan, Selector selector) throws IOException {
        ...
        final NonBlockingConnectionHandler handler = new NonBlockingConnectionHandler(
                ...
                clientChan,
                this);
        Integer connectionId = this.connections.addConnection(handler);
        handler.getProtocol().start(connectionId,this.connections);
